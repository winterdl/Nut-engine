...
private:
	...
	bool remotecell(std::array<std::array<int8_t, 15>, 15> board, int8_t row, int8_t col)const noexcept;
	std::vector<std::tuple<int, int8_t, int8_t>> genmove(std::array<std::array<int8_t, 15>, 15> board)const noexcept;
	std::vector<std::tuple<int, int8_t, int8_t>> smart_genmove(int turn, chessboard, int depth)noexcept;
